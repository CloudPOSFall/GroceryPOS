    ...
    <div class="wrapper" id="controlscreen">
      ...
      <div class="card-deck">
        ...
        <a class="btn" href="sale.php">
          <div class="card" id="pagecard">
            ...
            <span class="card-text" ><h5 class="card-title"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-cart-plus-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="btn" href="#">
          <div class="card" id="pagecard">
            <div class="card-body text-center">
            <span class="card-text" ><h5 class="card-title"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-bag-x-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="card-deck">
        ...
        <a class="btn" href="#">
          <div class="card" id="pagecard">
            <div class="card-body text-center">
            <span class="card-text" ><h5 class="card-title"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-caret-up-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="btn" href="#">
          <div class="card" id="pagecard">
            <div class="card-body text-center">
            <span class="card-text" ><h5 class="card-title"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-caret-down-square-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="btn" href="#">
          <div class="card" id="pagecard">
            <div class="card-body text-center">
            <span class="card-text"><h5 class="card-title"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-arrow-left-right" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="btn" href="#">
          <div class="card" id="pagecard">
            <div class="card-body text-center">
            <span class="card-text align-middle"><h5 class="card-title"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-cash-stack" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="card-deck">
        ...
        <a class="btn" href="#">
          <div class="card" id="pagecard">
            <div class="card-body text-center">
            <span class="card-text" ><h5 class="card-title"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-clock-history" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
