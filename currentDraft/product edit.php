...
if(isset($_POST['update']))
{
  ...
  $query = "update product_inventory set QR_code = '$_POST[qr]', serial_number = '$_POST[serial]', make = '$_POST[make]', model_number = '$_POST[model]', model_name = '$_POST[name]', description = '$_POST[d]', link_supplier_data = '$_POST[link]', cost = '$_POST[cost]', selling_price = '$_POST[price]', MSRP = '$_POST[msrp]', in_stock = '$_POST[in]', reorder_amount = '$_POST[amount]', base_stock = '$_POST[base]',
