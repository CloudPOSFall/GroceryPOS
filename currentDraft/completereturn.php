            ...
            <tbody>
                ...
                if(isset($_GET['Ret']))
                {
                    ...
                    $sql = "SELECT ticket_system.*, product_inventory.*, item_list.* FROM ticket_system 
                        ...
                        WHERE item_list.product_id LIKE '$product' AND item_list.CID=ticket_system.ticket_id";
                    $result = mysqli_query($conn, $sql);
                    
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo "<tr><td>"
                    . $row['brand'] . "</td><td>" . $row['description'] . "</td><td>" . $row['productName'] . "</td><td>" . $row['unit_price'] . "</td><td>"
                    . $row['qty'] . "</td><td>" . $row['tax'] . "</td><td>" . $row['subtotal'] . "</td><td>";
