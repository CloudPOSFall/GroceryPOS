  ...
  <nav id="sidebar">
    ...
    <ul class="list-unstyled components">
      <div class="card" id="navcard">
        <h5 class="text-center"><?php echo $name ?> <svg width=".6em" height=".6em" viewBox="0 0 16 16" class="bi bi-caret-down-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <li>
        <a href="salescontrolv3.php"><svg width=".8em" height=".8em" viewBox="0 0 16 16" class="bi bi-credit-card-2-back" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
