...
<body>
  ...
  <div id="content">
    ...
    if (($row['date'] >= $DateBegin) && ($row['date'] <= $DateEnd)){
        echo "<tr><td>" 
        . $row['ticket_id'] . "</td><td>". $row['time'] . "</td><td>" . $row['subtotal'] . "</td><td>" . $row['discount'] . "</td><td>" . $row['tax'] . "</td><td>" . $row['total'] . "</td><td>" . "</td><td>" 
        . "</td><td>" . "</td><td>" . date('m-d-Y', strtotime($row['date'])) . "</td><td><a class='btn btn-dark' 
