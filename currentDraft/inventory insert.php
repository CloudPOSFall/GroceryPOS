<?php
  ...
  if(isset($_POST['submit']))
  {
    ...
    else
    {
      ...
      $query = "insert into inventory_system (QR_code, serial_number, make, model_number, model_name, description, link_supplier_data, cost, selling_price, MSRP, in_stock, reorder_amount, base_stock, vendor_id)
