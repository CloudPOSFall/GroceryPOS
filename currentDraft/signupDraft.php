...
<link rel="stylesheet" type="text/css" href="styleDraft.css">
        ...
        <div class="row content">
            ...
            <div class="col-sm-4 text-left">
                <div class="jumbotron">
                  ...
                  <h1><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-basket2-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.929 1.757a.5.5 0 1 0-.858-.514L2.217 6H.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h.623l1.844 6.456A.75.75 0 0 0 3.69 15h8.622a.75.75 0 0 0 .722-.544L14.877 8h.623a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1.717L10.93 1.243a.5.5 0 1 0-.858.514L12.617 6H3.383L5.93 1.757zM4 10a1 1 0 0 1 2 0v2a1 1 0 1 1-2 0v-2zm3 0a1 1 0 0 1 2 0v2a1 1 0 1 1-2 0v-2zm4-1a1 1 0 0 0-1 1v2a1 1 0 1 0 2 0v-2a1 1 0 0 0-1-1z"/></svg>
                ...
                <div class="card card-body bg-light">
                    <form class="form-horizontal" action="/action_page.php">
                        <div class="form-group">
                            <input type="fullname" class="form-control" id="inputFullname" aria-describedby="fullname"
                        ...
                        <div class="form-group">
                            <input type="phone" class="form-control" id="inputphone" aria-describedby="phone"
                                placeholder="Phone Number">
                        </div>
                        <div class="form-group">
                            <input type="company" class="form-control" id="inputcompany" aria-describedby="company"
                                placeholder="Company">
                        </div>
                        <div class="form-group">
